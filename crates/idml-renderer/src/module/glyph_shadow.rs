...
use idml_compose::{BlendMode, DisplayCommand, DropShadow, Rect, Transform};
...
pub(crate) fn emit_glyph_shadow_pass(
    ...
    let mut inserts: Vec<(usize, Transform, idml_compose::PathId)> = Vec::new();
...
mod tests {
    use super::*;
    use idml_compose::{Color, DisplayList, DropShadow, Paint, PathData, PathSegment};
