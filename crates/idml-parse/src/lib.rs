...
pub use styles::{
    CellStyleDef, CharacterStyleDef, ObjectStyleDef, ParagraphShading, ParagraphStyleDef,
    ResolvedCell, ResolvedCharacter, ResolvedObject, ResolvedParagraph, ResolvedTable,
    StyleSheet, TOCStyleDef, TOCStyleEntryDef, TableStyleDef,
};
