...
impl SurfacePresenter {
    ...
    async fn new_inner(
        ...
        let (device, queue) = adapter
            .request_device(&wgpu::DeviceDescriptor {
                label: Some("paged-gpu surface device"),
                required_features,
    ...
    pub fn present_scenes(
        ...
        let mut encoder = self
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("paged-gpu surface blit scenes"),
            });
    ...
    /// matrix from `paged_compose::Transform`). The canvas worker
    ...
    pub fn present_multi(
        ...
        let mut encoder = self
            .device
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("paged-gpu surface blit multi"),
            });
        let surface_view = frame
            .texture
            .create_view(&wgpu::TextureViewDescriptor::default());
    ...
    pub fn present(
        ...
        let mut encoder = self
            .device
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("paged-gpu surface blit"),
            });
        let surface_view = frame
            .texture
            .create_view(&wgpu::TextureViewDescriptor::default());
    ...
    pub async fn render_scene_to_rgba(
        ...
        let target = self.device.create_texture(&wgpu::TextureDescriptor {
            label: Some("paged-gpu vello readback target"),
            size: wgpu::Extent3d {
                width: width_px,
                height: height_px,
        ...
        let readback = self.device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("paged-gpu vello readback buffer"),
            size: buffer_size,
        ...
        let mut encoder = self
            .device
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("paged-gpu vello readback encoder"),
            });
