...
/// JSON-friendly mirror of `paged_mutate::NodeId` — wasm-bindgen
/// serialises this directly rather than reaching into paged-mutate's
...
fn frames_for_spread(parsed: &paged_scene::ParsedSpread) -> Vec<FrameEntry> {
